            ...
            var e = function(g) {
                ...
                f = function(j, n) {
                    ...
                    if (n == "destroy") {
                        ...
                        v = e(v);
                        if (n.calendar != "false") {
                            z = ((w == "en") ? "<span class='clockdate'>" + c[w].weekdays[u] + ", " + c[w].months[k] + " " + i + ", " + q + "</span>" : "<span class='clockdate'>" + q + "年" + c[w].months[k] + "月" + i +"日"+"<br>"+ c[w].weekdays[u]+"</span>" )
                        }
                        $(j).html(z + "<span class='clocktime'>" + p + ":" + l + (n.seconds == "true" ? ":" + v : "") + o + "</span>");
